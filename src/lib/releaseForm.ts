// The Social Media Submission Form — single source of truth for its shape,
// question copy, defaults, and validation. The public form component, the
// modal, the Edge Function validator, and the records page all read from
// here. Do NOT duplicate question text in components.
//
// KEEP IN SYNC with supabase/functions/_shared/releaseForm.ts — that file is
// a Deno-compatible copy of this module (the Edge runtime cannot import from
// src/). The client validates for UX; the server validates for truth.
