import svgPaths from "./svg-wip1rnzfz9";
import imgSignatureHealthCareLogo from "./882942c430fe9ae4d9a411c594b0aa005ce4b7f3.png";
...
export default function EmployeeSpotlights() {
  return (
    <div className="relative size-full" style={{ backgroundImage: "linear-gradient(131.459deg, rgb(0, 103, 177) 46.497%, rgb(220, 235, 247) 100%)" }} data-name="employee-spotlights">
      ...
      <Star />
      <div className="absolute h-[133px] left-[103px] top-[1199px] w-[332px]" data-name="Signature HealthCARE Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgSignatureHealthCareLogo} />
      </div>
